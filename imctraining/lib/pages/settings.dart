      ...
      body: ListView(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Expanded(child: Text("${AppLocalizations.of(context)!.showproblems} 1: ${(100*context.watch<CurrentExerciseProvider>().aufgaben1geloest / context.watch<CurrentExerciseProvider>().aufgaben1gesamt).round()}% ${AppLocalizations.of(context)!.solved}", overflow: TextOverflow.ellipsis,)),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Expanded(child: Text("${AppLocalizations.of(context)!.showproblems} 2: ${(100*context.watch<CurrentExerciseProvider>().aufgaben2geloest / context.watch<CurrentExerciseProvider>().aufgaben2gesamt).round()}% ${AppLocalizations.of(context)!.solved}", overflow: TextOverflow.ellipsis,)),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Expanded(child: Text("${AppLocalizations.of(context)!.showproblems} 3: ${(100*context.watch<CurrentExerciseProvider>().aufgaben3geloest / context.watch<CurrentExerciseProvider>().aufgaben3gesamt).round()}% ${AppLocalizations.of(context)!.solved}", overflow: TextOverflow.ellipsis,)),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Expanded(child: Text("${AppLocalizations.of(context)!.showproblems} 4: ${(100*context.watch<CurrentExerciseProvider>().aufgaben4geloest / context.watch<CurrentExerciseProvider>().aufgaben4gesamt).round()}% ${AppLocalizations.of(context)!.solved}", overflow: TextOverflow.ellipsis,)),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Expanded(child: Text("${AppLocalizations.of(context)!.showproblems} 5: ${(100*context.watch<CurrentExerciseProvider>().aufgaben5geloest / context.watch<CurrentExerciseProvider>().aufgaben5gesamt).round()}% ${AppLocalizations.of(context)!.solved}", overflow: TextOverflow.ellipsis,)),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Expanded(child: Text("${AppLocalizations.of(context)!.showproblems} 6: ${(100*context.watch<CurrentExerciseProvider>().aufgaben6geloest / context.watch<CurrentExerciseProvider>().aufgaben6gesamt).round()}% ${AppLocalizations.of(context)!.solved}", overflow: TextOverflow.ellipsis,)),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Expanded(child: Text(AppLocalizations.of(context)!.problemsfromaspecifictopic, softWrap: true,)),
              Switch(
